# Run Record
ランナー向けのアプリケーションです。<br>
以下、メイン機能<br>
・お気に入りのランニングコースを投稿、それに対するコメント<br>
　→ユーザー同士のコミュニケーションの場に。<br>
　→普段同じコースばかり走る方のマンネリ化防止。<br>
 
・登録したベストタイムから、走力レベルに応じた練習メニューを提示。<br>
　→ベストタイムを更新するアクションが明確になる。<br>
　→結果が出ることで、モチベーションが下がりにくくなり、挫折の可能性が低下する。<br>
...
しかし人数が増えるにつれ、とても業務負荷が大きい作業となり、どうすればこの作業を効率化できるのかと<br>
悩んでいたことがありました。<br>
その当時、お客様自身がベストタイムを登録し、それを元に練習メニューが自動で作成されるアプリでもあればと<br>
考えていたことを思い出し、プログラミングを学んだ現在、そのアプリケーションを形にしました。<br>
また、ユーザーに積極的に使っていただくため、コミュニケーションの場として、ランニングコースを投稿できる機能を<br>
加えました。<br>
<br>
